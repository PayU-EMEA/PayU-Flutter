...
class _FakeAddCardServiceDelegate_0 extends _i1.SmartFake
    implements _i2.AddCardServiceDelegate {
  _FakeAddCardServiceDelegate_0(
    Object parent,
...
class _FakeCardToken_1 extends _i1.SmartFake implements _i3.CardToken {
  _FakeCardToken_1(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockAddCardPageControllerDelegate extends _i1.Mock
  ...
  @override
  void didComplete(_i3.CardToken? token) => super.noSuchMethod(
        Invocation.method(
          #didComplete,
          [token],
        ),
  ...
  @override
  void didFail(String? message) => super.noSuchMethod(
        Invocation.method(
          #didFail,
          [message],
        ),
...
class MockAddCardService extends _i1.Mock implements _i2.AddCardService {
  ...
  @override
  _i2.AddCardServiceDelegate get delegate => (super.noSuchMethod(
  ...
  @override
  set delegate(_i2.AddCardServiceDelegate? _delegate) => super.noSuchMethod(
        Invocation.setter(
          #delegate,
          _delegate,
        ),
  ...
  @override
  _i5.Future<_i3.CardToken> tokenize(bool? save) => (super.noSuchMethod(
        Invocation.method(
          #tokenize,
          [save],
        ),
        returnValue: _i5.Future<_i3.CardToken>.value(_FakeCardToken_1(
          this,
          Invocation.method(
            #tokenize,
            [save],
