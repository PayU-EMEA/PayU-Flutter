...
class _Api implements Api {
  ...
  @override
  Future<AuthorizationResponse> authorize(contentType, body) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AuthorizationResponse>(Options(
            ...
            .compose(_dio.options, 'pl/standard/user/oauth/authorize',
  ...
  Future<PaymentMethodsResponse> getPaymentMethods(contentType) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PaymentMethodsResponse>(Options(
                ...
                extra: _extra,
                contentType: contentType)
            .compose(_dio.options, 'api/v2_1/paymethods',
                queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<OrderCreateResponse> createOrder(contentType, request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Content-Type': contentType};
    _headers.removeWhere((k, v) => v == null);
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<OrderCreateResponse>(Options(
                ...
                extra: _extra,
                contentType: contentType)
            .compose(_dio.options, 'api/v2_1/orders',
                queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<InstallmentProposal> getCardInstallmentProposals(proposalId) async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<InstallmentProposal>(
  ...
  @override
  Future<void> postCardInstallmentProposals(proposalId, decision) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<TransactionsResponse> getTransactions(orderId) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<TransactionsResponse>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(
                    _dio.options, 'api/v2_1/orders/${orderId}/transactions',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
