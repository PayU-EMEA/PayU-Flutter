...
class _Api implements Api {
  ...
  Future<AuthorizationResponse> authorize(
    ...
    final _options = _setStreamType<AuthorizationResponse>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    late AuthorizationResponse _value;
    try {
      _value = AuthorizationResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<PaymentMethodsResponse> getPaymentMethods(String contentType) async {
    ...
    final _options = _setStreamType<PaymentMethodsResponse>(
      Options(
            method: 'GET',
            headers: _headers,
            extra: _extra,
