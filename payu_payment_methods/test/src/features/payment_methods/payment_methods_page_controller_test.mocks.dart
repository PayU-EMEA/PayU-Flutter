...
import 'package:payu_payment_methods/src/features/core/payment_methods_item.dart' as _i8;
import 'package:payu_payment_methods/src/features/core/payment_methods_storage.dart' as _i6;
import 'package:payu_payment_methods/src/features/payment_methods/payment_methods_controller.dart' as _i4;
import 'package:payu_payment_methods/src/features/payment_methods/payment_methods_listener.dart' as _i5;
import 'package:payu_payment_methods/src/payment_methods_configuration.dart' as _i3;
...
class _FakeBrandImageProvider_0 extends _i1.Fake implements _i2.BrandImageProvider {}

/// A class which mocks [PaymentMethodsConfiguration].
///
/// See the documentation for Mockito's code generation for more information.
class MockPaymentMethodsConfiguration extends _i1.Mock implements _i3.PaymentMethodsConfiguration {
  ...
  List<_i2.CardToken> get cardTokens =>
      (super.noSuchMethod(Invocation.getter(#cardTokens), returnValue: <_i2.CardToken>[]) as List<_i2.CardToken>);
  @override
  List<_i2.PayByLink> get payByLinks =>
      (super.noSuchMethod(Invocation.getter(#payByLinks), returnValue: <_i2.PayByLink>[]) as List<_i2.PayByLink>);
  @override
...
///
/// See the documentation for Mockito's code generation for more information.
class MockPaymentMethodsControllerDelegate extends _i1.Mock implements _i4.PaymentMethodsControllerDelegate {
...
class MockPaymentMethodsListener extends _i1.Mock implements _i5.PaymentMethodsListener {
  ...
  @override
  void didDeletePaymentMethod(_i2.PaymentMethod? paymentMethod) =>
...
///
/// See the documentation for Mockito's code generation for more information.
class MockPaymentMethodsItem extends _i1.Mock implements _i8.PaymentMethodsItem {
  MockPaymentMethodsItem() {
    _i1.throwOnMissingStub(this);
  }

  @override
  bool get enabled => (super.noSuchMethod(Invocation.getter(#enabled), returnValue: false) as bool);
  @override
  ...
  _i2.BrandImageProvider get brandImageProvider =>
      (super.noSuchMethod(Invocation.getter(#brandImageProvider), returnValue: _FakeBrandImageProvider_0())
          as _i2.BrandImageProvider);
  @override
  double get brandImageProviderSize =>
      (super.noSuchMethod(Invocation.getter(#brandImageProviderSize), returnValue: 0.0) as double);
}
