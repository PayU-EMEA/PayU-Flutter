...
class _FakeBrandImageProvider_0 extends _i1.SmartFake
    implements _i2.BrandImageProvider {
  _FakeBrandImageProvider_0(
    Object parent,
...
class MockPaymentMethodsConfiguration extends _i1.Mock
  ...
  @override
  List<_i2.CardToken> get cardTokens => (super.noSuchMethod(
        Invocation.getter(#cardTokens),
        returnValue: <_i2.CardToken>[],
      ) as List<_i2.CardToken>);

  @override
  List<_i2.PayByLink> get payByLinks => (super.noSuchMethod(
        Invocation.getter(#payByLinks),
        returnValue: <_i2.PayByLink>[],
      ) as List<_i2.PayByLink>);

  @override
  bool get enableAddCard => (super.noSuchMethod(
        Invocation.getter(#enableAddCard),
        returnValue: false,
      ) as bool);

  @override
  bool get enablePayByLinks => (super.noSuchMethod(
        Invocation.getter(#enablePayByLinks),
        returnValue: false,
      ) as bool);
}
...
class MockPaymentMethodsControllerDelegate extends _i1.Mock
  ...
  @override
  void didComplete(_i2.PaymentMethod? paymentMethod) => super.noSuchMethod(
        Invocation.method(
          #didComplete,
          [paymentMethod],
        ),
  ...
  @override
  void navigateToBankTransfer() => super.noSuchMethod(
        Invocation.method(
  ...
  @override
  void navigateToCardToken() => super.noSuchMethod(
        Invocation.method(
          #navigateToCardToken,
          [],
        ),
...
class MockPaymentMethodsStorage extends _i1.Mock
  ...
  @override
  _i8.Future<String?> getSelectedPaymentMethodHash() => (super.noSuchMethod(
        Invocation.method(
          #getSelectedPaymentMethodHash,
          [],
        ),
  ...
  @override
  _i8.Future<void> saveSelectedPaymentMethodHash(String? hash) =>
      (super.noSuchMethod(
        Invocation.method(
          #saveSelectedPaymentMethodHash,
          [hash],
        ),
...
class MockPaymentMethodsItem extends _i1.Mock
  ...
  @override
  _i2.BrandImageProvider get brandImageProvider => (super.noSuchMethod(
        Invocation.getter(#brandImageProvider),
        returnValue: _FakeBrandImageProvider_0(
          this,
          Invocation.getter(#brandImageProvider),
        ),
  ...
  @override
  double get brandImageProviderSize => (super.noSuchMethod(
        Invocation.getter(#brandImageProviderSize),
        returnValue: 0.0,
      ) as double);
}
